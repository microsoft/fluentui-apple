Pod::Spec.new do |s|
  ...
  s.osx.source_files   = "macos/OfficeUIFabric/**/*.{swift,h}"
  s.osx.resource_bundle = { 'FluentUIResources-macos' => "macos/OfficeUIFabric/**/*.{storyboard,xib,xcassets,strings,stringsdict}" }
end
