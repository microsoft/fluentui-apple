...
rsync -a $RSYNC_EXCLUDE_PARAMS Debug/FluentUI.framework/ nuget/Debug-macosx/FluentUI.framework/

make_dir_if_necessary "nuget/Ship-macosx"
rsync -a $RSYNC_EXCLUDE_PARAMS Release/FluentUI.framework/ nuget/Ship-macosx/FluentUI.framework/

make_dir_if_necessary "nuget/Debug-iphoneos"
rsync -a Debug-iphoneos/libFluentUILib.a nuget/Debug-iphoneos/
rsync -a $RSYNC_EXCLUDE_PARAMS Debug-iphoneos/FluentUILib.swiftmodule/ nuget/Debug-iphoneos/FluentUILib.swiftmodule/
...
rsync -a $RSYNC_EXCLUDE_PARAMS Release-iphoneos/FluentUILib.swiftmodule/ nuget/Ship-iphoneos/FluentUILib.swiftmodule/
...
rsync -a $RSYNC_EXCLUDE_PARAMS Debug-iphonesimulator/FluentUILib.swiftmodule/ nuget/Debug-iphonesimulator/FluentUILib.swiftmodule/
...
rsync -a $RSYNC_EXCLUDE_PARAMS Release-iphonesimulator/FluentUILib.swiftmodule/ nuget/Ship-iphonesimulator/FluentUILib.swiftmodule/
