...
@objc(STRFluentUIStyle) @objcMembers public class FluentUIStyle: NSObject {
	...
	public var _MSFHeaderFooterTokens: MSFHeaderFooterTokensAppearanceProxy?
	open func MSFHeaderFooterTokensStyle() -> MSFHeaderFooterTokensAppearanceProxy {
		if let override = _MSFHeaderFooterTokens { return override }
			return MSFHeaderFooterTokensAppearanceProxy(proxy: { return self })
		}
	public var MSFHeaderFooterTokens: MSFHeaderFooterTokensAppearanceProxy {
		get { return self.MSFHeaderFooterTokensStyle() }
		set { _MSFHeaderFooterTokens = newValue }
	}
	@objc(MSFHeaderFooterTokensAppearanceProxy) @objcMembers open class MSFHeaderFooterTokensAppearanceProxy: NSObject {
		public let mainProxy: () -> FluentUIStyle
		public init(proxy: @escaping () -> FluentUIStyle) {
			self.mainProxy = proxy
		}
	...
	public var _MSFPrimaryHeaderTokens: MSFPrimaryHeaderTokensAppearanceProxy?
	open func MSFPrimaryHeaderTokensStyle() -> MSFPrimaryHeaderTokensAppearanceProxy {
		if let override = _MSFPrimaryHeaderTokens { return override }
			return MSFPrimaryHeaderTokensAppearanceProxy(proxy: { return self })
		}
	public var MSFPrimaryHeaderTokens: MSFPrimaryHeaderTokensAppearanceProxy {
