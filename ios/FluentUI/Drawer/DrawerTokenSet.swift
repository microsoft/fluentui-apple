...
open class DrawerTokenSet: ControlTokenSet<DrawerTokenSet.Tokens> {
    ...
    override func defaultValue(_ token: Tokens) -> ControlTokenValue {
        ...
        case .drawerContentBackground:
            return .dynamicColor({
                DynamicColor(light: self.aliasTokens.backgroundColors[.neutral1].light,
        ...
        case .navigationBarBackground:
            return .dynamicColor({
                DynamicColor(light: self.aliasTokens.backgroundColors[.neutral1].light,
                              dark: self.globalTokens.neutralColors[.grey14])
            })
        ...
        case .minVerticalMargin:
            return .float({ self.globalTokens.spacing[.large] })
