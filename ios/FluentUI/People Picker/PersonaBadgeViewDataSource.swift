...
open class PersonaBadgeViewDataSource: BadgeViewDataSource {
    ...
    @objc public init(persona: Persona, style: Style = .default, size: Size = .medium) {
        self.persona = persona
        super.init(text: persona.name, style: style, size: size)
    }

    @objc public convenience init(persona: Persona, style: Style = .default, size: Size = .medium, customView: UIView? = nil) {
