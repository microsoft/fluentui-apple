...
public extension View {
    ...
    @ViewBuilder func shimmering(style: MSFShimmerStyle = .revealing,
        ...
        if isShimmering {
            modifier(ShimmerViewSwiftUI(state: MSFShimmerStateImpl(style: style,
...
public extension ShimmerViewSwiftUI {
    /// Provides a custom design token set to be used when drawing this control.
    func overrideTokens(_ tokens: ShimmerTokens?) -> ShimmerViewSwiftUI {
        state.overrideTokens = tokens
        return self
    }
}

public extension ShimmerLinesViewSwiftUI {
    /// Provides a custom design token set to be used when drawing this control.
    func overrideTokens(_ tokens: ShimmerTokens?) -> ShimmerLinesViewSwiftUI {
        state.overrideTokens = tokens
        return self
    }
}
