...
class NavigationControllerDemoController: DemoController {
    ...
    @objc func showLargeTitleWithSystemStyleAndShyAccessory() {
        presentController(withLargeTitle: true, style: .system, accessoryView: createAccessoryView(with: .onNavigationBar), contractNavigationBarOnScroll: true)
    }

    @objc func showLargeTitleWithSystemStyleAndFixedAccessory() {
        presentController(withLargeTitle: true, style: .system, accessoryView: createAccessoryView(with: .onNavigationBar), contractNavigationBarOnScroll: false)
    }
    ...
    @objc func showRegularTitleWithShyAccessory() {
        presentController(withLargeTitle: false, style: .system, accessoryView: createAccessoryView(with: .onNavigationBar), contractNavigationBarOnScroll: true)
    }
    ...
    @objc func showWithTopSearchBar() {
        presentController(withLargeTitle: true, style: .system, accessoryView: createAccessoryView(with: .onNavigationBar), showsTopAccessory: true, contractNavigationBarOnScroll: false)
    }

    @objc func showSearchChangingStyleEverySecond() {
        presentController(withLargeTitle: true, style: .system, accessoryView: createAccessoryView(with: .onNavigationBar), showsTopAccessory: true, contractNavigationBarOnScroll: false, updateStylePeriodically: true)
    }
    ...
    private func createAccessoryView(with style: SearchBar.Style = .onBrand) -> SearchBar {
