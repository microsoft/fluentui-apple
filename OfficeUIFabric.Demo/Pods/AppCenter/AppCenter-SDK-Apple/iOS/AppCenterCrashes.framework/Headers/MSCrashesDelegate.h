 ...
 *
 * @discussion Crashes will send logs to the server or discard/delete logs based
 ...
 * @param errorReport The errorReport that will be sent.
 *
 * @discussion Use this callback to display custom UI while crashes are sent to
 * the server.
 */
...
/**
 * Callback method that will be called in case the SDK was unable to send an
