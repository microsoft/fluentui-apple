...
/*
 * Version of the wrapper SDK. When the SDK is embedding another base SDK (for
 * example Xamarin.Android wraps Android), the Xamarin specific version is
 * populated into this field while sdkVersion refers to the original Android
 * SDK. [optional]
 */
...
/*
 * Version of the wrapper technology framework (Xamarin runtime version or
 * ReactNative or Cordova etc...).  [optional]
 */
@property(nonatomic, copy, readonly) NSString *wrapperRuntimeVersion;

/*
 * Label that is used to identify application code 'version' released via Live
 * Update beacon running on device.
 */
...
/*
 * Hash of all files (ReactNative or Cordova) deployed to device via LiveUpdate
 * beacon. Helps identify the Release version on device or need to download
 * updates in future
 */
