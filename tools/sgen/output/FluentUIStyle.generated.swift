...
@objc(STRFluentUIStyle) @objcMembers public class FluentUIStyle: NSObject {
	...
	//MARK: - GhostButton
	public var _GhostButton: GhostButtonAppearanceProxy?
	open func GhostButtonStyle() -> GhostButtonAppearanceProxy {
		if let override = _GhostButton { return override }
			return GhostButtonAppearanceProxy(proxy: { return FluentUIStyle.shared() })
		}
	public var GhostButton: GhostButtonAppearanceProxy {
		get { return self.GhostButtonStyle() }
		set { _GhostButton = newValue }
	}
	@objc(GhostButtonAppearanceProxy) @objcMembers open class GhostButtonAppearanceProxy: MSFButtonAppearanceProxy {

		//MARK: - GhostButtonborderColor
		override open func borderColorStyle() -> MSFButtonAppearanceProxy.borderColorAppearanceProxy {
			if let override = _borderColor { return override }
				return GhostButtonborderColorAppearanceProxy(proxy: mainProxy)
			}
		@objc(GhostButtonBorderColorAppearanceProxy) @objcMembers open class GhostButtonborderColorAppearanceProxy: MSFButtonAppearanceProxy.borderColorAppearanceProxy {
	...
	//MARK: - MSFButton
	public var _MSFButton: MSFButtonAppearanceProxy?
	open func MSFButtonStyle() -> MSFButtonAppearanceProxy {
		if let override = _MSFButton { return override }
			return MSFButtonAppearanceProxy(proxy: { return FluentUIStyle.shared() })
		}
	public var MSFButton: MSFButtonAppearanceProxy {
		get { return self.MSFButtonStyle() }
		set { _MSFButton = newValue }
	}
	@objc(MSFButtonAppearanceProxy) @objcMembers open class MSFButtonAppearanceProxy: NSObject {
		public let mainProxy: () -> FluentUIStyle
		public init(proxy: @escaping () -> FluentUIStyle) {
			self.mainProxy = proxy
		}
		...
		@objc(MSFButtonBackgroundColorAppearanceProxy) @objcMembers open class backgroundColorAppearanceProxy: NSObject {
			public let mainProxy: () -> FluentUIStyle
			public init(proxy: @escaping () -> FluentUIStyle) {
				self.mainProxy = proxy
			}
		...
		@objc(MSFButtonBorderColorAppearanceProxy) @objcMembers open class borderColorAppearanceProxy: NSObject {
			public let mainProxy: () -> FluentUIStyle
			public init(proxy: @escaping () -> FluentUIStyle) {
				self.mainProxy = proxy
			}
		...
		@objc(MSFButtonBorderRadiusAppearanceProxy) @objcMembers open class borderRadiusAppearanceProxy: NSObject {
			public let mainProxy: () -> FluentUIStyle
			public init(proxy: @escaping () -> FluentUIStyle) {
				self.mainProxy = proxy
			}
		...
		@objc(MSFButtonBorderSizeAppearanceProxy) @objcMembers open class borderSizeAppearanceProxy: NSObject {
			public let mainProxy: () -> FluentUIStyle
			public init(proxy: @escaping () -> FluentUIStyle) {
				self.mainProxy = proxy
			}
		...
		@objc(MSFButtonIconColorAppearanceProxy) @objcMembers open class iconColorAppearanceProxy: NSObject {
			public let mainProxy: () -> FluentUIStyle
			public init(proxy: @escaping () -> FluentUIStyle) {
				self.mainProxy = proxy
			}
		...
		@objc(MSFButtonIconSizeAppearanceProxy) @objcMembers open class iconSizeAppearanceProxy: NSObject {
			public let mainProxy: () -> FluentUIStyle
			public init(proxy: @escaping () -> FluentUIStyle) {
				self.mainProxy = proxy
			}
		...
		@objc(MSFButtonInterspaceAppearanceProxy) @objcMembers open class interspaceAppearanceProxy: NSObject {
			public let mainProxy: () -> FluentUIStyle
			public init(proxy: @escaping () -> FluentUIStyle) {
				self.mainProxy = proxy
			}
		...
		@objc(MSFButtonPaddingAppearanceProxy) @objcMembers open class paddingAppearanceProxy: NSObject {
			public let mainProxy: () -> FluentUIStyle
			public init(proxy: @escaping () -> FluentUIStyle) {
				self.mainProxy = proxy
			}
		...
		@objc(MSFButtonTextColorAppearanceProxy) @objcMembers open class textColorAppearanceProxy: NSObject {
			public let mainProxy: () -> FluentUIStyle
			public init(proxy: @escaping () -> FluentUIStyle) {
				self.mainProxy = proxy
			}
		...
		@objc(MSFButtonTextFontAppearanceProxy) @objcMembers open class textFontAppearanceProxy: NSObject {
			public let mainProxy: () -> FluentUIStyle
			public init(proxy: @escaping () -> FluentUIStyle) {
				self.mainProxy = proxy
			}
	...
	open func PrimaryButtonStyle() -> PrimaryButtonAppearanceProxy {
		if let override = _PrimaryButton { return override }
			return PrimaryButtonAppearanceProxy(proxy: { return FluentUIStyle.shared() })
		}
	public var PrimaryButton: PrimaryButtonAppearanceProxy {
		get { return self.PrimaryButtonStyle() }
		set { _PrimaryButton = newValue }
	}
	@objc(PrimaryButtonAppearanceProxy) @objcMembers open class PrimaryButtonAppearanceProxy: MSFButtonAppearanceProxy {

		//MARK: - PrimaryButtonbackgroundColor
		override open func backgroundColorStyle() -> MSFButtonAppearanceProxy.backgroundColorAppearanceProxy {
			if let override = _backgroundColor { return override }
				return PrimaryButtonbackgroundColorAppearanceProxy(proxy: mainProxy)
			}
		@objc(PrimaryButtonBackgroundColorAppearanceProxy) @objcMembers open class PrimaryButtonbackgroundColorAppearanceProxy: MSFButtonAppearanceProxy.backgroundColorAppearanceProxy {
		...
		//MARK: - PrimaryButtoniconColor
		override open func iconColorStyle() -> MSFButtonAppearanceProxy.iconColorAppearanceProxy {
			if let override = _iconColor { return override }
				return PrimaryButtoniconColorAppearanceProxy(proxy: mainProxy)
			}
		@objc(PrimaryButtonIconColorAppearanceProxy) @objcMembers open class PrimaryButtoniconColorAppearanceProxy: MSFButtonAppearanceProxy.iconColorAppearanceProxy {
		...
		//MARK: - PrimaryButtontextColor
		override open func textColorStyle() -> MSFButtonAppearanceProxy.textColorAppearanceProxy {
			if let override = _textColor { return override }
				return PrimaryButtontextColorAppearanceProxy(proxy: mainProxy)
			}
		@objc(PrimaryButtonTextColorAppearanceProxy) @objcMembers open class PrimaryButtontextColorAppearanceProxy: MSFButtonAppearanceProxy.textColorAppearanceProxy {
	...
	public var _SecondaryButton: SecondaryButtonAppearanceProxy?
	open func SecondaryButtonStyle() -> SecondaryButtonAppearanceProxy {
		if let override = _SecondaryButton { return override }
			return SecondaryButtonAppearanceProxy(proxy: { return FluentUIStyle.shared() })
		}
	public var SecondaryButton: SecondaryButtonAppearanceProxy {
		get { return self.SecondaryButtonStyle() }
		set { _SecondaryButton = newValue }
	}
	@objc(SecondaryButtonAppearanceProxy) @objcMembers open class SecondaryButtonAppearanceProxy: MSFButtonAppearanceProxy {

		//MARK: - SecondaryButtonborderColor
		override open func borderColorStyle() -> MSFButtonAppearanceProxy.borderColorAppearanceProxy {
			if let override = _borderColor { return override }
				return SecondaryButtonborderColorAppearanceProxy(proxy: mainProxy)
			}
		@objc(SecondaryButtonBorderColorAppearanceProxy) @objcMembers open class SecondaryButtonborderColorAppearanceProxy: MSFButtonAppearanceProxy.borderColorAppearanceProxy {
		...
		//MARK: - SecondaryButtonborderSize
		override open func borderSizeStyle() -> MSFButtonAppearanceProxy.borderSizeAppearanceProxy {
			if let override = _borderSize { return override }
				return SecondaryButtonborderSizeAppearanceProxy(proxy: mainProxy)
			}
		@objc(SecondaryButtonBorderSizeAppearanceProxy) @objcMembers open class SecondaryButtonborderSizeAppearanceProxy: MSFButtonAppearanceProxy.borderSizeAppearanceProxy {
...
extension MSFButton: AppearaceProxyComponent {

	public typealias ApperanceProxyType = FluentUIStyle.MSFButtonAppearanceProxy
	public var appearanceProxy: ApperanceProxyType {
		get {
			if let proxy = objc_getAssociatedObject(self, &__ApperanceProxyHandle) as? ApperanceProxyType {
				...
				if proxy is FluentUIStyle.GhostButtonAppearanceProxy {
					return StylesheetManager.stylesheet(FluentUIStyle.shared()).GhostButton
				} else if proxy is FluentUIStyle.PrimaryButtonAppearanceProxy {
					return StylesheetManager.stylesheet(FluentUIStyle.shared()).PrimaryButton
				} else if proxy is FluentUIStyle.SecondaryButtonAppearanceProxy {
					return StylesheetManager.stylesheet(FluentUIStyle.shared()).SecondaryButton
				}
				return proxy
			}

			return StylesheetManager.stylesheet(FluentUIStyle.shared()).MSFButton
		}
		set {
