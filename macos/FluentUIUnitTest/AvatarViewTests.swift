...
class AvatarViewTests: XCTestCase {
	...
	func testHashAlgorithm () {
		...
		XCTAssertEqual(colorSet.background, DynamicColor(light: Colors.Palette.platinumTint40.color, dark: Colors.Palette.platinumShade30.color))
		XCTAssertEqual(colorSet.foreground, DynamicColor(light: Colors.Palette.platinumShade30.color, dark: Colors.Palette.platinumTint40.color))
		colorSet = AvatarView.getInitialsColorSet(fromPrimaryText: "", secondaryText: "email@example.com")
		XCTAssertEqual(colorSet.background, DynamicColor(light: Colors.Palette.tealTint40.color, dark: Colors.Palette.tealShade30.color))
		XCTAssertEqual(colorSet.foreground, DynamicColor(light: Colors.Palette.tealShade30.color, dark: Colors.Palette.tealTint40.color))
		colorSet = AvatarView.getInitialsColorSet(fromPrimaryText: "", secondaryText: "happy@example.com")
		XCTAssertEqual(colorSet.background, DynamicColor(light: Colors.Palette.forestTint40.color, dark: Colors.Palette.forestShade30.color))
		XCTAssertEqual(colorSet.foreground, DynamicColor(light: Colors.Palette.forestShade30.color, dark: Colors.Palette.forestTint40.color))
