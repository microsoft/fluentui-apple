...
open class AvatarView: NSView {
	...
	/// Returns a hash value that can be mapped to color table index for a given display name
	/// - parameter identifyingString:the  identifying string for the user
	///
	/// - Returns: a  index generated by walking backwards through the letters in the \p identifyingString
