...
class AvatarViewTests: XCTestCase {
	...
	func testHashAlgorithm () {
		...
		XCTAssertEqual(colorSet.background, LegacyDynamicColor(light: Colors.Palette.cranberryTint40.color, dark: Colors.Palette.cranberryShade30.color))
		XCTAssertEqual(colorSet.foreground, LegacyDynamicColor(light: Colors.Palette.cranberryShade30.color, dark: Colors.Palette.cranberryTint40.color))
		colorSet = AvatarView.getInitialsColorSet(fromPrimaryText: "", secondaryText: "Maor.Sharett@example.com")
		XCTAssertEqual(colorSet.background, LegacyDynamicColor(light: Colors.Palette.anchorTint40.color, dark: Colors.Palette.anchorShade30.color))
		XCTAssertEqual(colorSet.foreground, LegacyDynamicColor(light: Colors.Palette.anchorShade30.color, dark: Colors.Palette.anchorTint40.color))
		colorSet = AvatarView.getInitialsColorSet(fromPrimaryText: "", secondaryText: "email@example.com")
		XCTAssertEqual(colorSet.background, LegacyDynamicColor(light: Colors.Palette.steelTint40.color, dark: Colors.Palette.steelShade30.color))
		XCTAssertEqual(colorSet.foreground, LegacyDynamicColor(light: Colors.Palette.steelShade30.color, dark: Colors.Palette.steelTint40.color))
		colorSet = AvatarView.getInitialsColorSet(fromPrimaryText: "", secondaryText: "happy@example.com")
		XCTAssertEqual(colorSet.background, LegacyDynamicColor(light: Colors.Palette.seafoamTint40.color, dark: Colors.Palette.seafoamShade30.color))
		XCTAssertEqual(colorSet.foreground, LegacyDynamicColor(light: Colors.Palette.seafoamShade30.color, dark: Colors.Palette.seafoamTint40.color))
		colorSet = AvatarView.getInitialsColorSet(fromPrimaryText: "", secondaryText: "Kat Larrson")
		XCTAssertEqual(colorSet.background, LegacyDynamicColor(light: Colors.Palette.steelTint40.color, dark: Colors.Palette.steelShade30.color))
		XCTAssertEqual(colorSet.foreground, LegacyDynamicColor(light: Colors.Palette.steelShade30.color, dark: Colors.Palette.steelTint40.color))
		colorSet = AvatarView.getInitialsColorSet(fromPrimaryText: "Satya Nadella", secondaryText: "")
		XCTAssertEqual(colorSet.background, LegacyDynamicColor(light: Colors.Palette.lilacTint40.color, dark: Colors.Palette.lilacShade30.color))
		XCTAssertEqual(colorSet.foreground, LegacyDynamicColor(light: Colors.Palette.lilacShade30.color, dark: Colors.Palette.lilacTint40.color))
		colorSet = AvatarView.getInitialsColorSet(fromPrimaryText: "Bill Gates", secondaryText: "")
		XCTAssertEqual(colorSet.background, LegacyDynamicColor(light: Colors.Palette.plumTint40.color, dark: Colors.Palette.plumShade30.color))
		XCTAssertEqual(colorSet.foreground, LegacyDynamicColor(light: Colors.Palette.plumShade30.color, dark: Colors.Palette.plumTint40.color))
		colorSet = AvatarView.getInitialsColorSet(fromPrimaryText: "", secondaryText: "")
		XCTAssertEqual(colorSet.background, LegacyDynamicColor(light: Colors.Palette.darkRedTint40.color, dark: Colors.Palette.darkRedShade30.color))
		XCTAssertEqual(colorSet.foreground, LegacyDynamicColor(light: Colors.Palette.darkRedShade30.color, dark: Colors.Palette.darkRedTint40.color))
